    ...
    <table>
        ...
        <?php while ($row = $result->fetch_assoc()) : ?>
            <tr>
                ...
                <td>
                    <form action="edit_supervisors.php" method="POST">
                        <input type="hidden" name="SSN" value="<?php echo $row['SSN']; ?>">
                        <input type="submit" value="Edit">
                    </form>
                    <form action="delete_supervisors.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this patient?');">
                        <input type="hidden" name="SSN" value="<?php echo $row['SSN']; ?>">

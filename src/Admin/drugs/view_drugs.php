    ...
    <table>
        ...
        <?php while ($row = $result->fetch_assoc()) : ?>
            <tr>
                ...
                <td>
                    <form action="edit_drugs.php" method="POST">
                        <input type="hidden" name="D_Name" value="<?php echo $row['D_Name']; ?>">
                        <input type="submit" value="Edit">
                    </form>
                    <form action="delete_drugs.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this drug?');">
                        <input type="hidden" name="D_Name" value="<?php echo $row['D_Name']; ?>">
